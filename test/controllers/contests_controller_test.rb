...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { description: @contest.description, end: @contest.end, name: @contest.name, start: @contest.start }
    end
  ...
  test "should update contest" do
    patch :update, id: @contest, contest: { description: @contest.description, end: @contest.end, name: @contest.name, start: @contest.start }
    assert_redirected_to contest_path(assigns(:contest))
  end
